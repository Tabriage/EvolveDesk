...
export function normalizeRemoteTransportConfig(value: RemoteTransportConfig): { objectUrl: string; bearerToken: string; sigv4: { accessKeyId: string; secretAccessKey: string; sessionToken: string; region: string; expiresAt: string } | null };
