...
- **多来源学习专题**：从真实视频总结和知识卡中选择最多 16 条资料，先离线保存专题资料架，再由本地 Agent 生成中心理解、2–8 个有据节点、支持/补充/冲突/依赖关系和待求证问题。每个节点的来源都会在服务端重新绑定，开放问题可以明确加入今日任务。
...
视频字幕、关键帧、OCR、视觉问答与多来源学习专题已经可用，后续继续补齐：

1. 知识卡、画面证据、学习专题与复习题之间的可视化关系图。
2. 专题内的资料增量更新与脉络差异审阅。
3. 提案分支、自动提交和远程协作审阅。
